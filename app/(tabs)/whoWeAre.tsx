    ...
    >
      ...
      <ThemedView>
        <ThemedText type="default">
          ...
          exepcional, enfocado en la atención al cliente.
        </ThemedText>
      </ThemedView>
      <ThemedView>
        ...
        <Collapsible title="Misión">
          <ThemedText type="default">
            Nuestra misión es proporcionar servicios de alta calidad que superen
        ...
        <Collapsible title="Visión">
          <ThemedText type="default">
            Nuestra visión es ser la empresa líder en servicios automotrices,
        ...
        <Collapsible title="Valores">
          <ThemedText type="default">
            Nuestros valores fundamentales son la integridad, la innovación y el
